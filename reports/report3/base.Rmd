...
The BIC and AIC heuristics also seem to disagree on which model to choose in this case. We would therefore opt for
...
and print a summary of this new model.
