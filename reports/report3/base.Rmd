...
## e) Modeling probability of failing
We now want to model the probability of a student failing maths instead of the individual grades, as done above.

Why is it not suitable to use a linear mixed effects model?
What type of model would be more suitable?
How would we add a random school intercept into this model (in which part of the model)?
WHat is the main challenge with this type of models?
