...
We have that $x_{\text{chogolisa, height}} = 7665$ and $x_{\test{chogolisa, prominence}} = 1624$. We calculate the estimated probability for success, and corresponding 95\% confidence interval, in the same way as for Mount Everest. In addition we calculate the estimated $y_{\text{chogolisa}}$ by $\hat y_{\text{chogolisa}} = \hat\pi_{\test{chogolosa}} n_{\text{chogolisa}}$, and the confidence interval.
