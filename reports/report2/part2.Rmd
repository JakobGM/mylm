...
temp_ya[temp_ya>4] <- rep(4, length(temp_ya[temp_ya>4]))
temp_yh[temp_yh>4] <- rep(4, length(temp_yh[temp_yh>4]))
...
## d) Simulation
We now want to investigate the results of future matches using our estimated strengths.
```{r}
