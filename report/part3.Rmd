...
The interpretation of the parameters are simply that as one of the covariates increase by one unit, the expected wage increase by the value of the coefficient. This means that as a person grows one year older, he is expected to increase his income by `r model2$coefficients[3]`. Similarly, as a person takes one year with education she is expected to grow her income by `r model2$coefficients[2]`.
