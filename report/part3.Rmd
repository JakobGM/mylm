...
On the other hand, if the covariates were completley independent, then the coefficients would remain the same, even if another covariate was added or removed. This is not the case here, which is quite intuitive considering that as one grows older one would typically have more education - and the other way around.
