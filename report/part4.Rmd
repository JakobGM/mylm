...
In the following section the `mylm` function will be employed to three different model suggestions. To evaluate the fit of these models we'll print the summary of the models to discuss the p-values of the parameters, as well as the residual plot to see if there are any clear trends in the residuals, or discrepancies from the normal assumption.
